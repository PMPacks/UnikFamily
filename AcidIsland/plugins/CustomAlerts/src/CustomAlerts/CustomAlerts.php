            ...
            switch($cause->getCause()){
                ...
                case EntityDamageEvent::CAUSE_ENTITY_ATTACK:
                    ...
                    if($killer instanceof Player){
                        ...
                        $array["ITEM"] = $killer->getInventory()->getItemInHand()->getName();
                        break;
                    }
                    if($killer instanceof Entity){
                        $array["KILLER"] = $killer->getNameTag();
                        $array["ITEM"] = "Unknown";
                        break;
                    }
                    if($killer instanceof Player && $killer->getInventory()->getItemInHand()->getId() == 0){
                        $array["KILLER"] = $killer->getName();
                        $array["ITEM"] = "Tay";
                        break;
                    }
