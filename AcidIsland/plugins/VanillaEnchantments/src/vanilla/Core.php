...
class Core extends PluginBase implements Listener{
	...
	public function registerTypes() : void{
		...
		Enchantment::registerEnchantment(new Enchantment(Enchantment::LURE, "Lure", Enchantment::RARITY_UNCOMMON, Enchantment::SLOT_FISHING_ROD, Enchantment::SLOT_NONE, 3));
		Enchantment::registerEnchantment(new Enchantment(Enchantment::LUCK_OF_THE_SEA, "Luck of the sea", Enchantment::RARITY_UNCOMMON, Enchantment::SLOT_FISHING_ROD, Enchantment::SLOT_NONE, 3));
	}
