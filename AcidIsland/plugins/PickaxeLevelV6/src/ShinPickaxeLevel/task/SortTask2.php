...
use ShinPickaxeLevel\form\TopForm2;
use pocketmine\form\Form;
use pocketmine\Player;
use pocketmine\scheduler\AsyncTask;
use pocketmine\Server;

class SortTask2 extends AsyncTask
{
    ...
    public function onCompletion(Server $server) : void
    {
        ...
        if ($this->receiver === "CONSOLE") {
            ...
            if (($player = Server::getInstance()->getPlayerExact($this->receiver)) instanceof Player) {
                ...
                $form = new TopForm2($player, $this->page, $this->max, explode("\n", $output), $closeForm);
                $player = Server::getInstance()->getPlayerExact($this->receiver);
