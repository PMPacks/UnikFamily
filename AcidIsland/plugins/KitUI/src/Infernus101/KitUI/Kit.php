...
class Kit {
	...
	public function add(Player $player){
		...
		isset($this->data["helmet"]) and $inv->addItem($this->loadItem(...explode(":", $this->data["helmet"])));
		isset($this->data["chestplate"]) and $inv->addItem($this->loadItem(...explode(":", $this->data["chestplate"])));
		isset($this->data["leggings"]) and $inv->addItem($this->loadItem(...explode(":", $this->data["leggings"])));
		isset($this->data["boots"]) and $inv->addItem($this->loadItem(...explode(":", $this->data["boots"])));
