...
class PureChat extends PluginBase
{
    ...
    */
     ...
     * @return mixed
     */
    public function applyPCTags($string, IPlayer $player, $message, $levelName)
    {
        // TODO
        $string = str_replace("{display_name}", $player->getName(), $string);
     ...
     * @return mixed
     */
    public function getChatFormat(IPlayer $player, $message, $levelName = null)
    {
     ...
     * @return mixed
     */
    public function getOriginalChatFormat($player, $levelName = null)
    {
     ...
     */
    public function getPrefix(IPlayer $player, $levelName = null)
    {
        if($levelName === null)
        {
     ...
     * @return mixed|null|string
     */
    public function getSuffix(IPlayer $player, $levelName = null)
    {
        if($levelName === null)
        {
     ...
     * @return bool
     */
    public function setPrefix($prefix, IPlayer $player, $levelName = null)
    {
        if($levelName === null)
        {
     ...
     * @return bool
     */
    public function setSuffix($suffix, IPlayer $player, $levelName = null)
    {
        if($levelName === null)
        {
