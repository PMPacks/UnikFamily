    ...
    private function onBossEventPacket(DataPacketReceiveEvent $e)
    {
        ...
        switch ($pk->eventType) {
            ...
            case BossEventPacket::TYPE_UNREGISTER_PLAYER:
                Server::getInstance()->getLogger()->debug("Got BossEventPacket " . ($pk->eventType === BossEventPacket::TYPE_REGISTER_PLAYER ? "" : "un") . "đăng ký bởi khách hàng cho id người chơi " . $pk->playerEid);
                break;
            default:
