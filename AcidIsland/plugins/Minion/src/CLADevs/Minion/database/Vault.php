...
class Vault{
	...
	public function __construct(Database $database, string $playername, int $number){
		...
		$this->menu = InvMenu::create(InvMenu::TYPE_DOUBLE_CHEST)
			->setListener(function(InvMenuTransaction $trans) : InvMenuTransactionResult{
				if(strtolower($this->playername) === $trans->getPlayer()->getLowerCaseName() || $trans->getPlayer()->hasPermission("playervaults.others.edit")) return $trans->continue();
